...
namespace AutoGeneratePostman.Controllers
{
    ...
    public class ObjectGenerator
    {
        ...
        private static object GenerateComplexObject(Type type, Dictionary<Type, object> createdObjectReferences)
        {
            ...
            result = type.IsValueType ? Activator.CreateInstance(type) : MyFactory.MyCreateInstance(type);
        ...
        public static class MyFactory
        {
            ...
            public static object MyCreateInstance(Type type)
            {
                ...
                //var enumerable = type.GetProperties(BindingFlags.Public | BindingFlags.Instance).ToList();
                ////GetIdForPassedInObject(parametrizedCtor);
                //foreach (var parameterInfo in enumerable)
                //{
                //    var sampleDataAttribute = parameterInfo.GetCustomAttribute(typeof(SampleDataAttribute),false);
                //    Console.WriteLine((SampleDataAttribute)sampleDataAttribute);
                //}
                ////.Select(p => p.Name);
